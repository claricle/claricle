...
0.7.23 and vectory 0.12.0** — three rows had drifted and are amended
above. See the measured-contracts section in 00. Re-run them if a
delegate version moves; that section exists because six
confidently-asserted contracts turned out false, and this round found
three more.
